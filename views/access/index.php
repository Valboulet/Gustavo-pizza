  ...
  <div>
    <div class="d-flex justify-content-center">
      <div class="txt-box">
        ...
        <div>
          <a class="btn m-1 px-5 py-2 bt-other" href="<?= $router->url('order') ?>" role="button">
            COMMANDER
          </a>
          <a class="btn m-1 px-5 py-2 bt-classic" href="#footer" role="button">
            CONTACT
          </a>
        </div>
      </div>
...
<div class="container text-center pt-5 content-box">
  <div class="row">
    <div class="col-md-6 col-lg-6 pt-5 px-5">
      ...
      <h5>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde dolorem consequatur aliquam debitis cumque ipsa
        amet quis laudantium fuga ratione?
      </h5>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-md-6 col-lg-6 pt-5 px-5 mb-5">
      ...
      <h5>
        Lorem, ipsum dolor sit amet consectetur adipisicing elit. In voluptate numquam atque quo accusantium
        reprehenderit dolores dolorum nesciunt sit sed repellat corporis, tempore ut laborum!
      </h5>
    </div>
  </div>
</div>
...
<div class="container d-flex justify-content-center align-items-center last-button">
  <a class="btn px-5 py-2 bt-other" href="<?= $router->url('order') ?>" role="button" >
    COMMANDER MES PIZZAS
  </a>
</div>